...
def main():
    ...
    all_lines = preprocess_lines(all_lines=all_lines)
    words = split_into_words(all_lines=all_lines)
    counter = count_words(words=words)
    write_count_words(counter=counter, output_folder=output_folder)
